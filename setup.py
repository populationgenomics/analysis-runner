...
setuptools.setup(
    ...
    install_requires=[
        ...
        'flake8-bugbear',
        'flask',
        'google-api-python-client>=2.10.0,<3',
        'google-auth>=1.27.0,<2',
        'google-cloud-logging>=3.1.1,<4',
        'google-cloud-pubsub>=2.3.0,<3',
        ...
        'pulumi-gcp',
        'requests',
        'tabulate>=0.8.9,<1',  # https://github.com/Azure/azure-cli/issues/20887
        'toml',
    ],
    entry_points={
